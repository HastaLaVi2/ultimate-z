...
<body class="back7">
    <div class="width-760 zMob768-widthAll horMid centerText">
        <img src="{$zContent->srcFull["images"]}/error/error-403.png" class="widthAll">
        <div class="text-center padB-100">
            ...
            <a href="{$zContent->srcFull["_main"]}" class="zButton secondary sweet">{$zThis["not-found-button"]}</a>
        </div>
    </div>
</body>
</html>
