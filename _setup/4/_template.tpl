        ...
        <div class="col-12 heightMinAll">
            <div class="width-600 zMob-widthAll heightMinAll index-5 whiteBack">
                <div class="padLR-128 zMob768-padLR-80 padTB-80">
                    ...
                    <p class="font-27_2 gray2 top-40 bottom-48"><a class="forceLink" href="{$zContent->srcFull["_main"]}_admin/index.php{if $smarty.get.lang}?lang={$smarty.get.lang}{/if}">{zThis z="Log in"}. <i class="fas fa-chevron-right"></i></a></p>
