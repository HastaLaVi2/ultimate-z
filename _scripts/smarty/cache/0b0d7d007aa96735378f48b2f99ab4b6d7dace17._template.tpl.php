<?php
/* Smarty version 3.1.39, created on 2021-08-12 15:34:56
  from '/Users/kerimcanayaz/Sites/donmezoglu/_setup/4/_template.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_61153fa09031f8_80200631',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'dc4e30a2f29529ec786d57ef7f3057297acc85f9' => 
    array (
      0 => '/Users/kerimcanayaz/Sites/donmezoglu/_setup/4/_template.tpl',
      1 => 1628782495,
      2 => 'file',
    ),
...
function content_61153fa09031f8_80200631 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="tr">
<head>
...
<link rel="alternate" hreflang="en" href="http://localhost/donmezoglu/enindex.php?view=setup/4&lang=tr" />
<link rel="alternate" hreflang="tr" href="http://localhost/donmezoglu/trindex.php?view=setup/4&lang=tr" />
...
<div class="bottom-10">
    ...
    <div class="boldText gray2 font-13 top--5">powered by <a href="https://onucyirmibir.com" target="_blank">13/21</a></div>
                ...
                <p class="font-27_2 gray2 top-20"><a href="http://localhost/donmezoglu/index.php?view=setup/3&lang=tr"><i class="fas fa-chevron-left"></i> Geri Dön</a></p>
                <div class="rad-5 height-10 widthAll grayBack1 bottom-20 hideRest">
                    <div class="floatingSpace back3 col-12 row-12">
                    </div>
                </div>
                <form id="zUser-create-form" class="zForm" method="POST" role="form" action="http://localhost/donmezoglu/index.php?view=setup/4&lang=tr">
                    
                    <div class="">
                        <input name="site_name" id="site_name" type="text" class="padL-45" placeholder="Site adı">
                    ...
                    <div class="help-box top-10 bottom-25 rad-4"></div>
                    <div class="">
                        <input name="email" id="email" type="text" class="padL-45" placeholder="Eposta">
                        <div class="floatingSpace font-25_6 padTB-13 padL-10 gray2">
                    ...
                    <div class="help-box top-10 bottom-25 rad-4"></div>
                    <div class="">
                        <input name="confirm_password" id="confirm_password" type="password" class="padL-45" placeholder="Tekrar Şifre">
                        <div class="floatingSpace font-25_6 padTB-13 padL-10 gray2">
                            <i class="far fa-shield-alt"></i>
                        </div>
                    </div>
                    ...
                    <div style="display:none;">
                        <input name="langcode" id="langcode" type="text" value="2">
                    </div>
                    <button id="btnSubmit" class="zButton primary widthAll zShadow">Oluştur</button>
                </form>
                <p class="font-27_2 gray2 top-40 bottom-48"><a href="http://localhost/donmezoglu/_admin/index.php?lang=tr">Giriş Yap. <i class="fas fa-chevron-right"></i></a></p>
