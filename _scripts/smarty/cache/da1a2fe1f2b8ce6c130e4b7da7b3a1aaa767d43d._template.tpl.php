...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.40',
  'unifunc' => 'content_61d9710a3b3fd9_72484336',
...
function content_61d9710a3b3fd9_72484336 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="tr">
<head>
    <title>Yasaklandı</title>
...
<body class="back7">
    <div class="width-760 zMob768-widthAll horMid centerText">
        <img src="http://localhost/ultimate-z/_media/error/error-403.png" class="widthAll">
        <div class="text-center padB-100">
            <h1 class="font-4rem">YASAKLANDI</h1>
            <p class="gray2 font-20 bottom-50 top-50">Bu sayfayı görmeye izniniz yok.</p>
            <a href="http://localhost/ultimate-z/" class="forceLink zButton secondary sweet">Anasayfaya Dön</a>
        </div>
    </div>
</body>
</html>
