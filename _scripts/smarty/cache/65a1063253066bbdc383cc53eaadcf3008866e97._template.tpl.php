...
function content_6115a31124f975_31000857 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Create Page | zAdmin</title>
...
<!-- alternate links -->
<link rel="alternate" hreflang="en" href="http://localhost/ultimate-z/_admin/layouts/pages/create/" />
            ...
            <ul class="cleanList font-16">
                ...
                <li class="top-0_5rem padTB-5">
                    ...
                    <ul class="zShow-side1 font-13 padL-2rem left-2rem toggled">
                        ...
                        <li class="weight-600">
                            <a href="http://localhost/ultimate-z/_admin/layouts/pages/" class="weight-700 text5">
                                Pages
                            </a>
                        </li>
                        <li class="weight-600">
...
<div class="padB-20 displayNone zMob1200-no"></div>
        ...
        <div class="font-24 text4">
            <h3 class="boldText">Create Page</h3>
        </div>
    ...
    <div class="col-12">
        <nav>
            <ol class="cleanList">
                <li><a href="http://localhost/ultimate-z/_admin/layouts/pages/" class="inLine font-16">
        ...
        <div class="whiteBack rad-15 pad-20 font-16">
            <form id="zPage-edit-form" class="zForm" method="POST" role="form" action="http://localhost/ultimate-z/_admin/layouts/pages/create/index.php">
                ...
                <div>
                    <h4 class="inLeft font-19 top-0 text4 boldText">Add New Page</h4>
                    <div class="rightText">
                ...
                <ul class="cleanList nextToEach bottom-10"><li class="padL-0"><div><input type="checkbox" id="checkbox1" name="categories[]" value="1"><label for="checkbox1">Main Menu</label></div></li></ul>
                <h6 class="bottom-10 top-0 font-1em">Title</h6>
                <div class="bottom-10">
                    <input name="page_url" id="page_url" type="text" class="padL-45" placeholder="URL with / at start">
