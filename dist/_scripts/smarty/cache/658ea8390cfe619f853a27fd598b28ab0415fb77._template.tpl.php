<?php
/* Smarty version 3.1.39, created on 2021-10-04 19:15:09
  from '/Users/kerimcanayaz/Sites/donmezoglu/_admin/users/_template.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_615b52bd0e2d14_93800704',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '07b817d936d57a93b1c4ceaebbcd0eadb08aba98' => 
    array (
      0 => '/Users/kerimcanayaz/Sites/donmezoglu/_admin/users/_template.tpl',
      1 => 1631789752,
      2 => 'file',
    ),
...
function content_615b52bd0e2d14_93800704 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="tr">
<head>
    <title>Kullanıcılar | zAdmin</title>
...
<!-- alternate links -->
<link rel="alternate" href="http://localhost/donmezoglu/_admin/users/" />
<link rel="alternate" hreflang="en" href="http://localhost/donmezoglu/en/_admin/users" />
<link rel="alternate" hreflang="tr" href="http://localhost/donmezoglu/tr/_admin/users" />
    ...
    <div class="boldText gray2 font-13 top--5">powered by <a href="https://onucyirmibir.com" target="_blank">13/21</a></div>
        ...
        <div class="top-40">
            <ul class="cleanList font-16">
                ...
                <li class="top-0_5rem padTB-5">
                    <a href="http://localhost/donmezoglu/_admin/users" class="pad-13 rad-10 blockThis back5 color-white">
...
<nav class="floatingTheRight top-30 right-30 fixed index-50">
    ...
    <div class="zShow-userMenu displayNone">
        ...
        <div class="font-24 text4 index-20 fixed" zMob-1200="padT-30" id="zPageTitle">
            <h3 class="boldText top-10">Kullanıcılar</h3>
        </div>
    ...
    <div class="betwixt-10 bottom-10">
                    <div class="col-4 bottom-20">
                                <a href="http://localhost/donmezoglu/_admin/profile/index.php?id_user=1">
...
<div class="zModal" id="modal1">
    ...
    <div class="zModalContent rad-15" zMob-768="zCol-11">
        <div class="pad-20">
                        <form  class="zForm" method="POST" role="form" action="http://localhost/donmezoglu/_admin/users/index.php">
...
<div class="zModal" id="modalzCreate">
    ...
    <div class="zModalContent rad-15" zMob-768="zCol-11">
        <div class="pad-20">
                        <form id="zUser-create-form" class="zForm" method="POST" role="form" action="http://localhost/donmezoglu/_admin/users/index.php">
                            <div class="modal-header bg-primary">
                    <h5 class="top-0 bottom-0 font-18">
                        Yeni Bir Kullanıcı Ekle
                    </h5>
        ...
        <div class='zGroup'>
            ...
            <select name='rank' class='top-0 bottom-0 pad-10' id='rank'>
                ...
                <option value='1' >Yönetici</option><option value='2' >Editör</option>
            </select>
        </div>
        <div class='help-box top-10 bottom-10 rad-4'></div>
        <div class='zGroup'>
