<?php
/* Smarty version 3.1.39, created on 2021-09-29 09:15:41
  from '/Users/kerimcanayaz/Sites/donmezoglu/_admin/advanced/database/table/_template.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_61542ebd06e300_60848073',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '42bf68566515de028dfe4e6c68cc172e15bffd1c' => 
    array (
      0 => '/Users/kerimcanayaz/Sites/donmezoglu/_admin/advanced/database/table/_template.tpl',
      1 => 1631203644,
      2 => 'file',
    ),
...
function content_61542ebd06e300_60848073 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="tr">
<head>
...
<!-- alternate links -->
<link rel="alternate" href="http://localhost/donmezoglu/_admin/advanced/database/table/" />
<link rel="alternate" hreflang="en" href="http://localhost/donmezoglu/en/_admin/advanced/database/tableindex.php?table=z" />
<link rel="alternate" hreflang="tr" href="http://localhost/donmezoglu/tr/_admin/advanced/database/tableindex.php?table=z" />
...
<div id="zLoad2" class="floatingSpace displayNone back7 widthAll heightAll fixed font-24 index-13 padL-332 zMob1200-padL-0">
    ...
    <div class="floatingTheSpace fixed index-1 height-100 widthAll">
        <div class="height-80 widthAll back7"></div>
        <div class="height-20 widthAll specGrad"></div>
    </div>
...
<nav class="floatingTheRight top-30 right-30 fixed index-50">
    ...
    <div class="zShow-userMenu displayNone">
        ...
        <div class="font-24 text4 index-2 fixed" zMob-1200="padT-10" id="zPageTitle">
            <h3 class="boldText">Tablo: z</h3>
        </div>

        <div class="padT-100" id="zContent">
            
            
    <nav>
        <ol class="cleanList">
            <li><a href="http://localhost/donmezoglu/_admin/advanced/database" class="inLine font-16">
    ...
    <div class="whiteBack rad-15 pad-20 font-16">
            ...
            <tbody>
                                    <tr>
                                                                                                                                                                                                <td>1</td>
                                                                                                            <td>D&ouml;nmezo&#287;lu Bili&#351;im</td>
                                                                                                            <td>clr7hntR7ymQQiViYzSU</td>
                                                                                                            <td>enabled</td>
                                                                                                            <td>enabled</td>
                                                <td class="zEdit">
...
<div class="zModal" id="modal0">
    ...
    <div class="zModalContent rad-15" zMob-768="zCol-11">
        <div class="pad-20">
                        <form  class="zForm" method="POST" role="form" action="http://localhost/donmezoglu/_admin/advanced/database/table/index.php?table=z">
                ...
                <div class="zInside gray2 font-15 padTB-20">
                    <div class="displayNone"><input type='text' name='type' value='edit_row'><input type='text' name='key' value='id_z'><input type='text' name='keyValue' value='1'></div>
                    
                                <div class='zGroup bottom-20'>
                                    <label class='back7 borderForm boldMin-1 boldNoR pad-10 text6' for='id_z'>
                                        id_z
                                    </label>
                                    
                                        <input type='text' name='id_z' class='top-0 bottom-0 pad-10' value='1'>
                                ...
                                <div class='zGroup bottom-20'>
                                    <label class='back7 borderForm boldMin-1 boldNoR pad-10 text6' for='name'>
                                        ...
                                        <input type='text' name='name' class='top-0 bottom-0 pad-10' value='Dönmezoğlu Bilişim'>
                                    
                                </div>
                                <div class='zGroup bottom-20'>
                                    <label class='back7 borderForm boldMin-1 boldNoR pad-10 text6' for='cookie_key'>
                                        cookie_key
                                    </label>
                                    
                                        <input type='text' name='cookie_key' class='top-0 bottom-0 pad-10' value='clr7hntR7ymQQiViYzSU'>
                                    
                                </div>
                                <div class='zGroup bottom-20'>
                                    <label class='back7 borderForm boldMin-1 boldNoR pad-10 text6' for='status'>
                                        status
                                    </label>
                                    
                                        <input type='text' name='status' class='top-0 bottom-0 pad-10' value='enabled'>
                                    
                                </div>
                                <div class='zGroup bottom-20'>
                                    <label class='back7 borderForm boldMin-1 boldNoR pad-10 text6' for='error'>
                                        error
                                    </label>
                                    
                                        <input type='text' name='error' class='top-0 bottom-0 pad-10' value='enabled'>
