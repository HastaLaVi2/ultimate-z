<?php
/* Smarty version 3.1.39, created on 2021-10-06 15:04:12
  from '/Users/kerimcanayaz/Sites/donmezoglu/_admin/layouts/pages/_template.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_615dbaec590696_92102930',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fb65b4bf465467ae9e3394e59b654c6ef4441180' => 
    array (
      0 => '/Users/kerimcanayaz/Sites/donmezoglu/_admin/layouts/pages/_template.tpl',
      1 => 1633372152,
      2 => 'file',
    ),
...
function content_615dbaec590696_92102930 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="tr">
<head>
...
<!-- alternate links -->
<link rel="alternate" href="http://localhost/donmezoglu/_admin/layouts/pages/" />
<link rel="alternate" hreflang="en" href="http://localhost/donmezoglu/en/_admin/layouts/pages" />
<link rel="alternate" hreflang="tr" href="http://localhost/donmezoglu/tr/_admin/layouts/pages" />
...
<nav class="floatingTheRight top-30 right-30 fixed index-50">
    ...
    <div class="col-12">
        <div class="whiteBack rad-15 pad-20 font-16">
            ...
            <a href="http://localhost/donmezoglu/_admin/layouts/pages/create/" class="zButton primary sweet font-16">
            ...
            <table class="zTable">
                ...
                <tbody>
                            ...
                            <td>1</td>
                            <td>Anasayfa</td>
                            <td>Dönmezoğlu Anasayfa</td>
                            <td>
                                <a href="http://localhost/donmezoglu/_admin/layouts/pages/edit/index.php?id_page=1001" class="zButton primary sweet">
                                     Düzenle
                                </a>
                            </td>
                            <td>
                                            ...
                                            <tr id="zPage-1005">
                            <td>5</td>
                            <td>Faaliyet Alanları</td>
                            <td>zAna</td>
                            <td>
                                <a href="http://localhost/donmezoglu/_admin/layouts/pages/edit/index.php?id_page=1005" class="zButton primary sweet">
                                     Düzenle
                                </a>
                            </td>
                            <td>
                                                                
<a href="#modal1005" class="zButton primary sweet font-16">Sil</a>

<div class="zModal" id="modal1005">
    <a class="zCancel" href="#"></a>
    <div class="zModalContent rad-15" zMob-768="zCol-11">
        <div class="pad-20">
                        <form  class="zForm" method="POST" role="form" action="http://localhost/donmezoglu/_admin/layouts/pages/index.php">
                ...
                <div class="rightText">
                        ...
                        <span>Evet</span>
                            ...
                            <td>zAna</td>
                            <td>
                                <a href="http://localhost/donmezoglu/_admin/layouts/pages/edit/index.php?id_page=1006" class="zButton primary sweet">
                                     Düzenle
                                </a>
                            </td>
                            <td>
                                                                
<a href="#modal1006" class="zButton primary sweet font-16">Sil</a>

<div class="zModal" id="modal1006">
    <a class="zCancel" href="#"></a>
    <div class="zModalContent rad-15" zMob-768="zCol-11">
        <div class="pad-20">
                        <form  class="zForm" method="POST" role="form" action="http://localhost/donmezoglu/_admin/layouts/pages/index.php">
                ...
                <div class="zInside gray2 font-15 padTB-20">
                    <div class="displayNone"><input name='id_page' value='1006'></div>
                    Bu sayfayı silmek istediğinize emin misiniz?
                </div>
                <div class="rightText">
                                        <a class="zButton backTrans boldMin-0 sweet font-16" href="#">
                        ...
                        <span>Evet</span>
                            ...
                            <td>zAna</td>
                            <td>
                                <a href="http://localhost/donmezoglu/_admin/layouts/pages/edit/index.php?id_page=1007" class="zButton primary sweet">
                                     Düzenle
                                </a>
                            </td>
                            <td>
                                                                
<a href="#modal1007" class="zButton primary sweet font-16">Sil</a>

<div class="zModal" id="modal1007">
    <a class="zCancel" href="#"></a>
    <div class="zModalContent rad-15" zMob-768="zCol-11">
        <div class="pad-20">
                        <form  class="zForm" method="POST" role="form" action="http://localhost/donmezoglu/_admin/layouts/pages/index.php">
                ...
                <div class="zInside gray2 font-15 padTB-20">
                    <div class="displayNone"><input name='id_page' value='1007'></div>
                    Bu sayfayı silmek istediğinize emin misiniz?
                </div>
                <div class="rightText">
                                        <a class="zButton backTrans boldMin-0 sweet font-16" href="#">
                        ...
                        <span>Evet</span>
                            ...
                            <td>zAna</td>
                            <td>
                                <a href="http://localhost/donmezoglu/_admin/layouts/pages/edit/index.php?id_page=1008" class="zButton primary sweet">
                                     Düzenle
                                </a>
                            </td>
                            <td>
                                                                
<a href="#modal1008" class="zButton primary sweet font-16">Sil</a>

<div class="zModal" id="modal1008">
    <a class="zCancel" href="#"></a>
    <div class="zModalContent rad-15" zMob-768="zCol-11">
        <div class="pad-20">
                        <form  class="zForm" method="POST" role="form" action="http://localhost/donmezoglu/_admin/layouts/pages/index.php">
                ...
                <div class="zInside gray2 font-15 padTB-20">
                    <div class="displayNone"><input name='id_page' value='1008'></div>
                    Bu sayfayı silmek istediğinize emin misiniz?
                </div>
                <div class="rightText">
                                        <a class="zButton backTrans boldMin-0 sweet font-16" href="#">
