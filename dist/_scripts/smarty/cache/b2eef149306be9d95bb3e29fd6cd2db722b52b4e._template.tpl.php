<?php
/* Smarty version 3.1.39, created on 2021-10-05 09:23:47
  from '/Users/kerimcanayaz/Sites/donmezoglu/_admin/layouts/pages/edit/_template.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.39',
  'unifunc' => 'content_615c19a33b3e76_93107926',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cdce94fe18bc9f72ed9c8e58b300c2446626e414' => 
    array (
      0 => '/Users/kerimcanayaz/Sites/donmezoglu/_admin/layouts/pages/edit/_template.tpl',
      1 => 1633376476,
      2 => 'file',
    ),
    ...
    '8980d10c90b5a2cd3a176a539bf65146fe6d3b4e' => 
    array (
      0 => '/Users/kerimcanayaz/Sites/donmezoglu/_admin/_partials/holderEdit.tpl',
      1 => 1632988440,
      2 => 'file',
    ),
...
function content_615c19a33b3e76_93107926 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="tr">
<head>
...
<!-- alternate links -->
<link rel="alternate" href="http://localhost/donmezoglu/_admin/layouts/pages/edit/" />
<link rel="alternate" hreflang="en" href="http://localhost/donmezoglu/en/_admin/layouts/pages/editindex.php?id_page=1001" />
<link rel="alternate" hreflang="tr" href="http://localhost/donmezoglu/tr/_admin/layouts/pages/editindex.php?id_page=1001" />
...
<div id="zLoad0_2" class="floatingSpace back7 widthAll heightAll fixed font-24 index-101">
    ...
    <div id="zHead">
    <!-- summernote -->
    <link rel="stylesheet" href="http://localhost/donmezoglu/_scripts/summernote/summernote-lite.min.css">

    <!-- filepond -->
    <link rel="stylesheet" href="http://localhost/donmezoglu/_scripts/filepond/filepond.css">
    <link rel="stylesheet" href="http://localhost/donmezoglu/_scripts/filepond/filepond-plugin-image-preview.css">
    <link rel="stylesheet" href="http://localhost/donmezoglu/_scripts/filepond/filepond-plugin-media-preview/filepond-plugin-media-preview.min.css">
    <style>
            ...
            <ul class="cleanList font-16">
                ...
                <li class="top-0_5rem padTB-5">
                    ...
                    <ul class="zShow-side1 font-13 padL-2rem left-2rem toggled">
                        ...
                        <li class="weight-600">
                            <a href="http://localhost/donmezoglu/_admin/layouts/pages/index.php" class="weight-700 text5">
                                Sayfalar
                            </a>
                        </li>
                        <li class="weight-600">
...
<nav class="floatingTheRight top-30 right-30 fixed index-50">
    ...
    <div class="col-12">
        <nav>
            <ol class="cleanList">
                <li><a href="http://localhost/donmezoglu/_admin/layouts/pages/index.php" class="inLine font-16">
        ...
        <div class="whiteBack rad-15 pad-20 font-16">
            <form id="zPage-edit-form" class="zForm" method="POST" role="form" enctype="multipart/form-data" action="http://localhost/donmezoglu/_admin/layouts/pages/edit/index.php?id_page=1001">
                ...
                <div>
                    <div class="inLeft index-10">
                        ...
                        <h4 class="font-19 top-0 text4 boldText">
                            Anasayfa
                            <span class="font-14"><a href="http://localhost/donmezoglu/tr/" target="_blank">[Sayfayı Görüntüle]</a></span>
                        </h4>
                    </div>
                ...
                <ul class="cleanList nextToEach bottom-10"><li class="padL-0"><div><input type="checkbox" id="checkbox1" name="categories[]" value="1"checked><label for="checkbox1">Ana Menü</label></div></li></ul>
    ...
    <div class="zDestroy-holder1 grayBack1 pad-40 zMob-pad-20 rad-5 boldMin-1" style="border-color: var(--zFormBorderColor)" data="1">
        ...
        <div class="padT-20 hideForAdd">
            ...
            <input name="id_holder[]" type="text" value="6" class="displayNone">
            <input name="id_page_holder[]" type="text" value="" class="displayNone">
                            <div class="hiddenData displayNone">
                                                                    <textarea name="content[1][]" data-type="input">
        ...
        <div class="zDestroy-holder7 grayBack1 pad-40 zMob-pad-20 rad-5 boldMin-1" style="border-color: var(--zFormBorderColor)" data="7">
        <h6 class="bottom--10 top--10 left--10 right--10 font-1_5em thinText">
            Koyu Mavi Başlık Bölümü
        </h6>
        <div class="text5 font-25 floatingTheRight pad-32 zMob-pad-20 index-10 top--10 right--10 hideForAdd">
            <span class="pointThis toggleParentNext">
                <i class="fas fa-chevron-down arrows" style="display:none"></i>
            ...
            <a href="#modal7" class="zModalLink">
                <i class="fas fa-times"></i>
            </a>
        </div>
        <div class="padT-20 hideForAdd">
                ...
                <div class="zModalContent rad-15">
                    <div class="pad-20">
                        ...
                        <div class="rightText">
                            ...
                            <a class="zButton primary sweet font-16 zRemove-holder7" href="#">
                                <span>Evet</span>
                            </a>
                        </div>
                    </div>
            ...
            <input name="id_holder[]" type="text" value="7" class="displayNone">
            <input name="id_page_holder[]" type="text" value="" class="displayNone">
                            <div class="hiddenData displayNone">
                                                                    <textarea name="content[1][]" data-type="input">
        ...
        <div class="zDestroy-holder8 grayBack1 pad-40 zMob-pad-20 rad-5 boldMin-1" style="border-color: var(--zFormBorderColor)" data="8">
        <h6 class="bottom--10 top--10 left--10 right--10 font-1_5em thinText">
            Sayfa Başlığı
        </h6>
        <div class="text5 font-25 floatingTheRight pad-32 zMob-pad-20 index-10 top--10 right--10 hideForAdd">
            ...
            <a href="#modal8" class="zModalLink">
                <i class="fas fa-times"></i>
            </a>
        </div>
        <div class="padT-20 hideForAdd">
                ...
                <div class="zModalContent rad-15">
                    <div class="pad-20">
                        ...
                        <div class="rightText">
                            ...
                            <a class="zButton primary sweet font-16 zRemove-holder8" href="#">
                                <span>Evet</span>
                            </a>
                        </div>
                    </div>
            ...
            <input name="id_holder[]" type="text" value="8" class="displayNone">
            <input name="id_page_holder[]" type="text" value="" class="displayNone">
                            <div class="hiddenData displayNone">
                                                                    <textarea name="images[1][]" data-type="image">
        ...
        <div class="zDestroy-holder9 grayBack1 pad-40 zMob-pad-20 rad-5 boldMin-1" style="border-color: var(--zFormBorderColor)" data="9">
        <h6 class="bottom--10 top--10 left--10 right--10 font-1_5em thinText">
            Hakkımızda Kişisi
        </h6>
        <div class="text5 font-25 floatingTheRight pad-32 zMob-pad-20 index-10 top--10 right--10 hideForAdd">
            ...
            <a href="#modal9" class="zModalLink">
                <i class="fas fa-times"></i>
            </a>
        </div>
        <div class="padT-20 hideForAdd">
                ...
                <div class="zModalContent rad-15">
                    <div class="pad-20">
                        ...
                        <div class="rightText">
                            ...
                            <a class="zButton primary sweet font-16 zRemove-holder9" href="#">
                                <span>Evet</span>
                            </a>
                        </div>
                    </div>
            ...
            <input name="id_holder[]" type="text" value="9" class="displayNone">
            <input name="id_page_holder[]" type="text" value="" class="displayNone">
                            <div class="hiddenData displayNone">
                                                                    <textarea name="content[1][]" data-type="input">
        ...
        <div class="zDestroy-holder10 grayBack1 pad-40 zMob-pad-20 rad-5 boldMin-1" style="border-color: var(--zFormBorderColor)" data="10">
        <h6 class="bottom--10 top--10 left--10 right--10 font-1_5em thinText">
            Video Başlık
        </h6>
        <div class="text5 font-25 floatingTheRight pad-32 zMob-pad-20 index-10 top--10 right--10 hideForAdd">
            ...
            <a href="#modal10" class="zModalLink">
                <i class="fas fa-times"></i>
            </a>
        </div>
        <div class="padT-20 hideForAdd">
                ...
                <div class="zModalContent rad-15">
                    <div class="pad-20">
                        ...
                        <div class="rightText">
                            ...
                            <a class="zButton primary sweet font-16 zRemove-holder10" href="#">
                                <span>Evet</span>
                            </a>
                        </div>
                    </div>
            ...
            <input name="id_holder[]" type="text" value="10" class="displayNone">
            <input name="id_page_holder[]" type="text" value="" class="displayNone">
                            <div class="hiddenData displayNone">
                                                                    <textarea name="images[1][]" data-type="image">
        ...
        <div class="zDestroy-holder11 grayBack1 pad-40 zMob-pad-20 rad-5 boldMin-1" style="border-color: var(--zFormBorderColor)" data="11">
        <h6 class="bottom--10 top--10 left--10 right--10 font-1_5em thinText">
            Slayt
        </h6>
        <div class="text5 font-25 floatingTheRight pad-32 zMob-pad-20 index-10 top--10 right--10 hideForAdd">
            ...
            <a href="#modal11" class="zModalLink">
                <i class="fas fa-times"></i>
            </a>
        </div>
        <div class="padT-20 hideForAdd">
                ...
                <div class="zModalContent rad-15">
                    <div class="pad-20">
                        ...
                        <div class="rightText">
                            ...
                            <a class="zButton primary sweet font-16 zRemove-holder11" href="#">
                                <span>Evet</span>
                            </a>
                        </div>
                    </div>
            ...
            <input name="id_holder[]" type="text" value="11" class="displayNone">
            <input name="id_page_holder[]" type="text" value="" class="displayNone">
                            <div class="hiddenData displayNone">
        ...
        <div class="zDestroy-holder12 grayBack1 pad-40 zMob-pad-20 rad-5 boldMin-1" style="border-color: var(--zFormBorderColor)" data="12">
        <h6 class="bottom--10 top--10 left--10 right--10 font-1_5em thinText">
            Kısa Başlık
        </h6>
        <div class="text5 font-25 floatingTheRight pad-32 zMob-pad-20 index-10 top--10 right--10 hideForAdd">
            ...
            <a href="#modal12" class="zModalLink">
                <i class="fas fa-times"></i>
            </a>
        </div>
        <div class="padT-20 hideForAdd">
                ...
                <div class="zModalContent rad-15">
                    <div class="pad-20">
                        ...
                        <div class="rightText">
                            ...
                            <a class="zButton primary sweet font-16 zRemove-holder12" href="#">
                                <span>Evet</span>
                            </a>
                        </div>
                    </div>
            ...
            <input name="id_holder[]" type="text" value="12" class="displayNone">
            <input name="id_page_holder[]" type="text" value="" class="displayNone">
                            <div class="hiddenData displayNone">
                                                                    <textarea name="content[1][]" data-type="no">
                            
                        </textarea>
                                                                    <textarea name="content[2][]" data-type="no">
...
<footer class="font-16 text6 padT-40 bottom-50">
    ...
    <!-- summernote -->
    <script src="http://localhost/donmezoglu/_scripts/summernote/summernote-lite.min.js"></script>
        <script src="http://localhost/donmezoglu/_scripts/summernote/lang/summernote-tr-TR.min.js"></script>
    
    <!-- filepond plugins -->
    <script src="http://localhost/donmezoglu/_scripts/filepond/filepond-plugin-file-validate-size.js"></script>
    <script src="http://localhost/donmezoglu/_scripts/filepond/filepond-plugin-file-validate-type.js"></script>
    <script src="http://localhost/donmezoglu/_scripts/filepond/filepond-plugin-file-rename.js"></script>
    <script src="http://localhost/donmezoglu/_scripts/filepond/filepond-plugin-image-preview.js"></script>
    <script src="http://localhost/donmezoglu/_scripts/filepond/filepond-plugin-media-preview/filepond-plugin-media-preview.min.js"></script>

    <!-- filepond -->
    <script src="http://localhost/donmezoglu/_scripts/filepond/locale/tr-TR.js"></script>
    <script src="http://localhost/donmezoglu/_scripts/filepond/filepond.js"></script>
    ...
    <script>
        ...
        function uploadImage(image, summernote, filepond, filepondID) {
            ...
            $.ajax({
                url: "http://localhost/donmezoglu/_media/upload.php",
                cache: false,
                contentType: false,
                processData: false,
                data: data,
                ...
                success: function(filename) {
                    ...
                    var image = $("<img>").attr("src", "http://localhost/donmezoglu/_media/uploads/1001/" + filename).addClass("img-fluid");
                    if (summernote) {
